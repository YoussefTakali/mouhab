...
export class SidebarComponent implements OnInit, OnDestroy {
  ...
  private readonly navItems: NavItem[] = [
    ...
    { path: '/map', label: 'Carte', icon: 'fa-solid fa-map-location-dot' },
    { path: '/clients', label: 'Clients', icon: 'fa-solid fa-building-user', roles: ['SUPERVISOR', 'EMPLOYER', 'ADMIN'] },
    ...
    { path: '/salary-advances', label: 'Avances', icon: 'fa-solid fa-money-bill-wave' },

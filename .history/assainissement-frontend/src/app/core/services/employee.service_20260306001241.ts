...
import { Employee, CreateEmployeeRequest } from '../models/user.model';
...
export class EmployeeService {
  ...
  createEmployee(request: CreateEmployeeRequest): Observable<Employee> {
    return this.http.post<Employee>(this.API_URL, request);
  }
  ...
  updateMyProfile(employee: Partial<Employee>): Observable<Employee> {
    return this.http.put<Employee>(`${this.API_URL}/me/profile`, employee);
  }
}

...
@Component({
  ...
  styles: [`
    ...
    .card-left {
      flex: 1;
      background: linear-gradient(160deg, #8B0000 0%, #C9190D 50%, #a71d2a 100%);
      padding: 2rem 1.5rem;
      display: flex;
    ...
    .form-input:focus {
      outline: none;
      border-color: #C9190D;
      box-shadow: 0 0 0 3px rgba(201, 25, 13, 0.08);
    }
    ...
    .login-btn {
      ...
      cursor: pointer;
      transition: all 0.3s ease;
      box-shadow: 0 4px 12px rgba(201, 25, 13, 0.3);
      display: flex;
      align-items: center;
      justify-content: center;
      gap: 0.5rem;
    ...
    .login-btn:hover:not(:disabled) {
      ...
      box-shadow: 0 6px 18px rgba(201, 25, 13, 0.4);
    }

              ...
              @for (mission of selectedDay()!.missions; track mission.id) {
                <a [routerLink]="['/missions', mission.id]" class="panel-mission-card">
                  ...
                  <div class="mission-info">
                    ...
                    <h4>{{ mission.title }}</h4>
                    <p class="mission-address">📍 {{ mission.address }}</p>
                    <p class="mission-client" *ngIf="mission.clientName">
                      🏢 {{ mission.clientName }}
                    </p>
                    <p class="mission-assigned" *ngIf="mission.assignedEmployeeName">
                      👤 {{ mission.assignedEmployeeName }}
                    </p>
                  </div>
...
export class CalendarComponent implements OnInit {
  ...
  loadMissions(): void {
    ...
    this.missionService.getMissionsForCalendar(start, end).subscribe({

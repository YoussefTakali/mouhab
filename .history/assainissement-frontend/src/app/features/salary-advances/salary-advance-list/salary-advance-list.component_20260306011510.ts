            ...
            <div class="advance-card" [class]="'status-' + advance.status?.toLowerCase()">
              <div class="advance-header">
                <div class="advance-info">
                  ...
                  <div class="advance-employee">
                    <i class="fa-solid fa-user"></i>
                    {{ advance.employeeName || 'Employé inconnu' }}
                  </div>
                </div>
              ...
              <div class="advance-details">
                <div class="detail-item">
                  ...
                  <span>Date souhaitée: {{ advance.requestedDate ? (advance.requestedDate | date:'dd/MM/yyyy') : 'Non spécifiée' }}</span>
                </div>
                @if (advance.reason) {
                  <div class="detail-item">
    ...
    this.salaryAdvanceService.getMyAdvances().subscribe({
      next: (advances) => {
        ...
        if (advances && advances.length > 0) {
          console.log('First advance object keys:', Object.keys(advances[0]));
          console.log('First advance:', advances[0]);
        }

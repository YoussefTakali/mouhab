...
import { Employee, CreateEmployeeRequest } from '../../../core/models/user.model';
...
export class EmployeeListComponent implements OnInit {
  ...
  toggleSkill(skill: string): void {
    const skills = this.newEmployee.skills || [];
    ...
    this.newEmployee.skills = [...skills];
  }

  createEmployee(): void {
    if (!this.newEmployee.email || !this.newEmployee.password || 
        !this.newEmployee.firstName || !this.newEmployee.lastName) {

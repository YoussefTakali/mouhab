    ...
    <div class="dashboard">
      ...
      <section class="welcome-section">
        <div class="welcome-content">
          <h2>Bonjour, {{ currentUser()?.firstName }}! <i class="fa-solid fa-hand"></i></h2>
      ...
      <section class="stats-section">
        <div class="stats-grid">
          <div class="stat-card">
            <div class="stat-icon missions"><i class="fa-solid fa-clipboard-list"></i></div>
          ...
          <div class="stat-card">
            <div class="stat-icon progress"><i class="fa-solid fa-arrows-rotate"></i></div>
            <div class="stat-content">
          ...
          <div class="stat-card points-card">
            <div class="stat-icon points"><i class="fa-solid fa-trophy"></i></div>
            <div class="stat-content">
          ...
          <div class="stat-card" *ngIf="isSupervisor()">
            <div class="stat-icon team"><i class="fa-solid fa-users"></i></div>
            <div class="stat-content">
      ...
      <section class="quick-actions">
        ...
        <div class="actions-grid">
          ...
          <a routerLink="/calendar" class="action-card">
            <span class="action-icon"><i class="fa-regular fa-calendar-days"></i></span>
            <span class="action-label">Calendrier</span>
          </a>
          <a routerLink="/absences/new" class="action-card">
            <span class="action-icon"><i class="fa-solid fa-umbrella-beach"></i></span>
          ...
          <a routerLink="/approvals" class="action-card" *ngIf="isSupervisor()">
            <span class="action-icon"><i class="fa-solid fa-circle-check"></i></span>
      ...
      <div class="content-grid">
        ...
        <section class="dashboard-card missions-today">
          <div class="card-header">
            <h3><i class="fa-solid fa-clipboard-list"></i> Missions du Jour</h3>
            <a routerLink="/missions" class="view-all">Voir tout →</a>
          </div>
          <div class="card-content">
            @if (todayMissions().length === 0) {
              <div class="empty-state">
                <span class="empty-icon"><i class="fa-solid fa-party-horn" style="font-size:inherit"></i></span>
        ...
        <section class="dashboard-card urgent-missions" *ngIf="urgentMissions().length > 0">
          <div class="card-header">
            <h3><i class="fa-solid fa-triangle-exclamation"></i> Missions Urgentes</h3>
          </div>
          <div class="card-content">
            <div class="missions-list">
        ...
        <section class="dashboard-card awaiting-approval" *ngIf="isSupervisor() && awaitingApproval().length > 0">
          <div class="card-header">
            <h3><i class="fa-solid fa-clock"></i> En Attente d'Approbation</h3>
            ...
            <div class="missions-list">
              @for (mission of awaitingApproval(); track mission.id) {
                <a [routerLink]="['/missions', mission.id]" class="mission-item">
                  <div class="mission-info">
                    <h4>{{ mission.title }}</h4>
                    <p>{{ mission.assignedToName || mission.assignedEmployeeName }} - {{ mission.completedAt | date:'dd/MM/yyyy HH:mm' }}</p>
                  </div>

    ...
    <div class="leaderboard-page">
      <div class="page-header">
        <div class="header-content">
          <h1><i class="fa-solid fa-trophy"></i> Classement</h1>
      ...
      <div class="your-position-card" *ngIf="myPosition()">
        <div class="position-icon"><i class="fa-solid fa-location-dot"></i></div>
      ...
      <div class="leaderboard-card">
        ...
        <div class="leaderboard-list" *ngIf="!isLoading()">
          @for (entry of leaderboard(); track entry.employeeId; let i = $index) {
            ...
            >
              <div class="rank-cell">
                @if (i === 0) {
                  <span class="rank-medal gold"><i class="fa-solid fa-medal"></i></span>
                } @else if (i === 1) {
                  <span class="rank-medal silver"><i class="fa-solid fa-medal"></i></span>
                } @else if (i === 2) {
                  <span class="rank-medal bronze"><i class="fa-solid fa-medal"></i></span>
                } @else {
        ...
        <div class="empty-state" *ngIf="!isLoading() && leaderboard().length === 0">
          <span class="empty-icon"><i class="fa-solid fa-trophy"></i></span>

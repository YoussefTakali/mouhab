    ...
    <div class="approvals-page">
      <div class="page-header">
        <div class="header-content">
          <h1><i class="fa-solid fa-clipboard-check"></i> Approbations en Attente</h1>
      ...
      <div class="tabs">
        ...
        >
          <i class="fa-solid fa-umbrella-beach"></i> Absences
      ...
      <div class="tab-content" *ngIf="activeTab() === 'missions'">
              ...
              <div class="approval-info">
                ...
                <div class="approval-meta">
                  <span class="meta-item">
                    <i class="fa-solid fa-user"></i> {{ mission.employeeName || 'Non assigné' }}
                  </span>
                  <span class="meta-item">
                    <i class="fa-solid fa-location-dot"></i> {{ mission.address }}
                  </span>
                  <span class="meta-item">
                    <i class="fa-regular fa-calendar"></i> {{ mission.scheduledDate | date:'dd/MM/yyyy' }}
                  </span>
                </div>

                <div class="photos-preview" *ngIf="mission.photos?.length">
                  <span class="photos-count"><i class="fa-solid fa-camera"></i> {{ mission.photos!.length }} photos</span>
                </div>
              </div>
        ...
        <div class="empty-state" *ngIf="pendingMissions().length === 0">
          <span class="empty-icon"><i class="fa-solid fa-circle-check"></i></span>
          ...
          @for (absence of pendingAbsences(); track absence.id) {
            <div class="approval-card">
              ...
              <div class="approval-info">
                ...
                <div class="approval-meta">
                  <span class="meta-item">
                    <i class="fa-solid fa-user"></i> {{ absence.employeeName }}
                  </span>
                  <span class="meta-item">
                    <i class="fa-regular fa-calendar"></i> {{ absence.startDate | date:'dd/MM/yyyy' }} → {{ absence.endDate | date:'dd/MM/yyyy' }}
                  </span>
                </div>
              </div>
...
export class ApprovalListComponent implements OnInit {
  ...
  loadData(): void {
    ...
    this.absenceService.getPendingAbsences().subscribe({
      ...
      error: (err: unknown) => console.error('Failed to load absences:', err)
    });
  }
